...
def _parse_query(query: str) -> dict:
    """
    Use the LLM to extract description, size, and max_price from a freeform query.
    ...
    prompt = (
        ...
        '{"description": "<keywords for the item>", "size": "<size string or null>", "max_price": <number or null>}'
    )
